                    ...
                    <div class="w-full m-1 max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800    dark:border-gray-700 basis-1/5">
                        ...
                        <div class="px-5 pb-5">
                            ...
                            <div class="flex grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-4 lg:items-center lg:justify-between md:justify-normal mx-auto">
                                ...
                                <button data-modal-target="popup-modal" data-modal-toggle="popup-modal" class="block text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm m-3 px-2.5 py-2 text-center" type="button">
                                    Beli
                                </button>
                                    ...
                                    <div class="relative w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-6 text-center">
                                                ...
                                                <a data-modal-hide="popup-modal" type="button" class="text-white bg-green-600 hover:bg-green-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2" href="login.php">
                                                    Login
                                                </a>
                                                <button data-modal-hide="popup-modal" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 text-center">Batal</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
