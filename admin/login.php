  ...
  <section class="bg-neutral-100 dark:bg-gray-900">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
        <img class="w-8 h-8 mr-2" src="/apotech/assets/img/logo_transparan.png" alt="logo">
      ...
      <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-green-950 dark:border-gray-700">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <p class="text-sm font-light text-gray-500 dark:text-gray-400">
              <a href="/apotech/login.php" class="font-medium text-green-600 hover:underline dark:text-green-500">Masuk sebagai user</a>
            </p>
        </div>
      </div>
    </div>
