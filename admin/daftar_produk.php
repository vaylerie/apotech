...
if (isset($_POST['nama_obat']) && isset($_POST['kategori_obat']) && isset($_POST['deskripsi']) && isset($_POST['kemasan']) && isset($_POST['dosis']) && isset($_POST['efek_samping']) && isset($_POST['tgl_expired']) && isset($_POST['harga']) && isset($_POST['stok']) && isset($_POST['gambar'])) {
   ...
   $query = "SELECT * FROM detail_obat WHERE nama_obat='$nama_obat'";
   $result = mysqli_query($mysqli, $query);

   if (mysqli_num_rows($result) > 0) {
      echo "<script>alert('Produk telah tersedia. Silakan masukkan produk lain.'); document.location.href = '/apotech/admin/daftar_produk.php'</script>";
      exit();
   } else {
      $insert = "INSERT INTO detail_obat (nama_obat, kategori_obat, deskripsi, kemasan, dosis, efek_samping, tgl_expired, harga, stok, gambar) VALUES ('$nama_obat', '$kategori_obat', '$deskripsi', '$kemasan', '$dosis', '$efek_samping', '$tgl_expired', '$harga', '$stok', '$gambar')";
      mysqli_query($mysqli, $insert);
      echo "<script>alert('Produk baru berhasil ditambahkan!'); document.location.href = '/apotech/admin/daftar_produk.php'</script>";
   }
}
?>
<!DOCTYPE html>
   ...
   <div class="p-4 sm:ml-64">
      <div class="p-4">
         <h1 class="mb-10 text-2xl font-semibold leading-none tracking-tight text-black md:text-3xl lg:text-4xl">
            Manajemen Data Produk</h1>
         <div class="p-4 border-2 border-gray-200 rounded-lg">
            <div class="flex justify-between items-center">
               <h4 class="mb-10 text-xl font-medium leading-none mr-2 mb-2 px-5 py-2.5 tracking-tight text-black">Tabel Daftar Produk</h4>
                  ...
                  <div class="relative w-full max-w-md max-h-full">
                     ...
                     <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="px-6 py-6 lg:px-8">
                           ...
                           <form class="space-y-6" action="daftar_produk.php" method="POST">
                              <div>
                                 <label for="nama_obat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Produk</label>
                                 <input type="text" name="nama_obat" id="nama_obat" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="nama produk" required>
                              </div>
                              <label for="kategori_obat" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Pilih kategori</label>
                              <select id="kategori_obat" type="text" name="kategori_obat" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                                 <option selected disabled value="">Kategori</option>
                                 <option>Analgesik</option>
                                 <option>Antiseptik</option>
                              ...
                              <div>
                                 ...
                                 <input type="text" name="deskripsi" id="deskripsi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="deskripsi">
                              </div>
                              <div>
                                 <label for="kemasan" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kemasan</label>
                                 <input type="text" name="kemasan" id="kemasan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="kemasan">
                              </div>
                              <div>
                                 <label for="dosis" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Dosis</label>
                                 <input type="text" name="dosis" id="dosis" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="dosis">
                              </div>
                              <div>
                                 <label for="efek_samping" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Efek samping</label>
                                 <input type="text" name="efek_samping" id="efek_samping" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="efek samping">
                              </div>
                              <div>
                                 <label for="tgl_expired" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal expired</label>
                                 <input type="date" name="tgl_expired" id="tgl_expired" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5">
                              </div>
                              <div>
                                 <label for="harga" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga</label>
                                 <input type="text" name="harga" id="harga" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="harga">
                              </div>
                              <div>
                                 <label for="stok" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Stok</label>
                                 <input type="text" name="stok" id="stok" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5" placeholder="stok">
                              </div>
                              <div>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
               <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                     <?php
                     $query = "SELECT * FROM detail_obat ORDER BY kd_obat deSC";
                     $result = mysqli_query($mysqli, $query);
                     ...
                     ?>
                           <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                              <td class="px-6 py-4"><?php echo $kd_obat; ?></td>
                              <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"><?php echo $nama_obat; ?></td>
                              <td class="px-6 py-4"><?php echo $deskripsi; ?></td>
                              <td class="px-6 py-4"><img src="<?php echo $gambar; ?>" alt="Gambar Obat"></td>
                              <td class="px-6 py-4"><?php echo $kategori_obat; ?></td>
                              <td class="px-6 py-4 whitespace-nowrap"><?php echo $harga; ?></td>
                              <td class="px-6 py-4"><?php echo $stok; ?></td>
                              <td class="px-6 py-4"><?php echo $kemasan; ?></td>
                              <td class="px-6 py-4"><?php echo $dosis; ?></td>
                              <td class="px-6 py-4"><?php echo $efek_samping; ?></td>
                              <td class="px-6 py-4 whitespace-nowrap"><?php echo $tgl_expired; ?></td>
                              <td class="px-6 py-4 flex justify-between">
                                    ...
                                    <div class="relative w-full max-w-md max-h-full">
                                       <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                          ...
                                          <div class="p-6 text-center">
                                             ...
                                             <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah anda yakin untuk menghapus produk ini?</h3>
                                             <a data-modal-hide="popup-modal" type="submit" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2" href="hapus_produk.php?kd_obat=<?php echo $kd_obat; ?>">
                                                Ya, hapus
                                             </a>
                                 ...
                                 <a class="block text-blue-700 hover:underline font-medium text-sm px-5 py-2.5 text-center" type="button" href="edit_produk.php?kd_obat=<?php echo $kd_obat; ?>">
                                    Edit
                                 </a>
                              </td>
                           </tr>
